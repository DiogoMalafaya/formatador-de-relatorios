/**
 * Single-weight line icons (Lauda iconography: one open line-icon set, ~16px,
 * inheriting text colour). Paths are from Lucide (ISC licence), inlined so the
 * handful we use doesn't pull in a dependency. Always decorative — pair every
